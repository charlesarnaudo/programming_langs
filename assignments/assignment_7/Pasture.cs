...
public class Pasture
{
    ...
    private int tigers = 5;
    private int cows = 10;
    private int grass = 50;
    ...
    public Pasture()
    {
        ...
        for (int i = 0; i < width; i++)
        {
            ...
            AddEntity(new Fence(this), new Point(i, this.height - 1));
        }
        ...
        {
            IEntity cow = new Cow(this, 60, 5, 30);
        ...
        {
            IEntity tiger = new Tiger(this, 100, 2, 50);
